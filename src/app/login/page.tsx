    ...
    <div className="flex items-center justify-center flex-1 px-4">
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold">Welcome to Cybermusic</h1>
          <p className="text-zinc-400 mt-2">Choose how to sign in</p>
        </div>
        ...
        <button
          ...
          className="w-full py-3 border border-zinc-700 rounded-lg font-medium hover:bg-zinc-800 transition flex items-center justify-center gap-2"
        >
